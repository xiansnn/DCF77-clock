...
class DCF_Display_nanoGUI():
    def __init__(self):
        ...
        self.lbl_date = Label(self.wri_date, 70, 2, 125, align=ALIGN_CENTER)
        self.lbl_hours = Label(self.wri_hours, 90, 2, 100, align=ALIGN_CENTER)
        self.lbl_seconds = Label(self.wri_seconds, 100, 100, 10, align=ALIGN_CENTER)
        self.lbl_time_zone= Label(self.wri,2, 85, 2, align=ALIGN_CENTER)
